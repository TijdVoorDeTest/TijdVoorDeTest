...
final class QuizFinalizeTest extends AbstractControllerWebTestCase
{
    ...
    public function testFinalizeSetsFinalizedAt(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/finalize', $quiz->id), ['_token' => $token]);
    ...
    public function testFinalizeRefusedWhenQuizHasErrors(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/finalize', $invalidQuiz->id), ['_token' => $token]);
    ...
    public function testEnableRefusedWhenNotFinalized(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/season/krtek/quiz/%s/enable', $quiz->id), ['_token' => $token]);
    ...
    public function testUnfinalize(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/unfinalize', $quiz->id), ['_token' => $token]);
    ...
    public function testUnfinalizeRefusedWhenQuizIsActive(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/unfinalize', $quiz1->id), ['_token' => $token]);
    ...
    public function testClearQuizResetsFinalization(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/clear', $quiz->id), ['_token' => $token]);
    ...
    public function testDeactivateWithRedirectQuizStaysOnQuizOverview(): void
    {
        ...
        $this->client->request(
            Request::METHOD_POST,
            '/molshoop/season/krtek/quiz/null/enable',
            ['_token' => $token, 'redirect_quiz' => (string) $quiz2->id],
        );

        self::assertResponseRedirects(\sprintf('/molshoop/season/krtek/quiz/%s/overview', $quiz2->id));
