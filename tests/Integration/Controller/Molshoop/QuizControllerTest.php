...
use Tvdt\Controller\Molshoop\QuizController;
...
final class QuizControllerTest extends AbstractControllerWebTestCase
{
    ...
    {
        return $this->getCsrfTokenFromPage(\sprintf('/molshoop/season/krtek/quiz/%s/overview', $quiz->id), $formActionContains);
    }
    ...
    public function testIndexRedirectsToOverview(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s', $quiz->id));

        self::assertResponseRedirects(\sprintf('/molshoop/season/krtek/quiz/%s/overview', $quiz->id));
    }
    ...
    public function testOverviewLoadsSuccessfully(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/overview', $quiz->id));
    ...
    public function testResultTabLoadsSuccessfully(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/result', $quiz->id));
    ...
    public function testCandidatesTabLoadsSuccessfully(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/candidates-list', $quiz->id));
    ...
    public function testAnswerMappingRedirectsToFirstQuestion(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/answer-mapping', $quiz->id));
    ...
    public function testIndexRejectsQuizFromAnotherSeason(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s', $foreignQuiz->id));
    ...
    public function testOverviewRejectsQuizFromAnotherSeason(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/overview', $foreignQuiz->id));
    ...
    public function testResultRejectsQuizFromAnotherSeason(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/result', $foreignQuiz->id));
    ...
    public function testCandidatesTabRejectsQuizFromAnotherSeason(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/candidates-list', $foreignQuiz->id));
    ...
    public function testAnswerMappingRejectsQuizFromAnotherSeason(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/answer-mapping', $foreignQuiz->id));
    ...
    public function testCandidatesQuestionTabLoadsSuccessfully(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/candidates/%s', $quiz->id, $question->id));
    ...
    public function testCandidatesQuestionRejectsQuestionFromAnotherQuiz(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/candidates/%s', $quiz->id, $otherQuestion->id));
    ...
    public function testSaveCandidateAnswersPersistsSelection(): void
    {
        ...
        $url = \sprintf('/molshoop/season/krtek/quiz/%s/candidates/%s', $quiz->id, $question->id);
    ...
    public function testEnableQuizRejectsQuizFromAnotherSeason(): void
    {
        ...
        $token = $this->getCsrfTokenFromPage(
            \sprintf('/molshoop/season/krtek/quiz/%s/overview', $this->getQuizByName('Quiz 1')->id),
            '/enable',
        );

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/season/krtek/quiz/%s/enable', $foreignQuiz->id), [
            '_token' => $token,
        ]);
    ...
    public function testToggleCandidateCreatesInactiveQuizCandidate(): void
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/candidates-list', $quiz->id));
        self::assertResponseIsSuccessful();
        $token = (string) $crawler->filter(\sprintf('form[action*="/%s/toggle"] input[name="_token"]', $candidate->id))->first()->attr('value');

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/candidate/%s/toggle', $quiz->id, $candidate->id), [
            '_token' => $token,
        ]);
    ...
    public function testToggleCandidateRejectsCandidateFromAnotherSeason(): void
    {
        ...
        $token = $this->getCsrfTokenFromPage(\sprintf('/molshoop/season/krtek/quiz/%s/candidates-list', $quiz->id), '/toggle');

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/candidate/%s/toggle', $quiz->id, $foreignCandidate->id), [
            '_token' => $token,
        ]);
    ...
    public function testResetCandidateProgressRejectsCandidateFromAnotherSeason(): void
    {
        ...
        $token = $this->getCsrfTokenFromPage(\sprintf('/molshoop/season/krtek/quiz/%s/candidates-list', $quiz->id), '/reset');

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/candidate/%s/reset', $quiz->id, $foreignCandidate->id), [
            '_token' => $token,
        ]);
    ...
    public function testModifyResultRejectsCandidateFromAnotherSeason(): void
    {
        ...
        $token = $this->getCsrfTokenFromPage(\sprintf('/molshoop/season/krtek/quiz/%s/result', $quiz->id), '/modify_result');

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/candidate/%s/modify_result', $quiz->id, $foreignCandidate->id), [
            '_token' => $token,
            'corrections' => '1.5',
            'penalty' => '30',
        ]);
    ...
    public function testResetCandidateProgressDeletesGivenAnswersAndClearsStarted(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/candidate/%s/reset', $quiz->id, $candidate->id), [
            '_token' => $token,
        ]);
    ...
    public function testModifyResult(): void
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/result', $quiz->id));
        self::assertResponseIsSuccessful();
        $token = (string) $crawler->filter(\sprintf('form[action*="%s/modify_result"] input[name="_token"]', $candidate->id))->first()->attr('value');

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/candidate/%s/modify_result', $quiz->id, $candidate->id), [
            '_token' => $token,
            'corrections' => '1.5',
            'penalty' => '30',
        ]);
    ...
    public function testModifyDropouts(): void
    {
        ...
        $token = $this->getCsrfTokenFromPage(\sprintf('/molshoop/season/krtek/quiz/%s/result', $quiz->id), '/modify_dropouts');

        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/modify_dropouts', $quiz->id), [
            '_token' => $token,
            'dropouts' => '2',
        ]);
    ...
    public function testDeleteQuiz(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/quiz/%s/delete', $quiz->id), [
            '_token' => $token,
        ]);

        self::assertResponseRedirects('/molshoop/season/krtek');
        $this->entityManager->clear();
    ...
    public function testOverviewLoadsForEmptyQuiz(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/overview', $emptyQuiz->id));
    ...
    public function testAnswerMappingRedirectsWithFlashWhenNoQuestions(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, \sprintf('/molshoop/season/krtek/quiz/%s/answer-mapping', $emptyQuiz->id));

        self::assertResponseRedirects(\sprintf('/molshoop/season/krtek/quiz/%s/overview', $emptyQuiz->id));
