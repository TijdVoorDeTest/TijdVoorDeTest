...
use Tvdt\Controller\Molshoop\QuestionBankController;
...
final class QuestionBankControllerTest extends AbstractControllerWebTestCase
{
    ...
    public function testIndexListsBankQuestions(): void
    {
        ...
        $this->client->request(Request::METHOD_GET, '/molshoop/season/krtek/question-bank');
    ...
    public function testIndexFiltersByLabel(): void
    {
        ...
        $crawler = $this->client->request(Request::METHOD_GET, '/molshoop/season/krtek/question-bank?label='.$label->slug);
    ...
    {
        $this->loginAs('krtek-admin@example.org');
        $crawler = $this->client->request(Request::METHOD_GET, '/molshoop/season/krtek/question-bank/new');
        $this->assertResponseIsSuccessful();

        $token = (string) $crawler->filter('input[name="bank_question_form[_token]"]')->attr('value');

        $this->client->request(Request::METHOD_POST, '/molshoop/season/krtek/question-bank/new', [
            'bank_question_form' => [
        ...
        $this->assertResponseRedirects('/molshoop/season/krtek/question-bank');
    ...
    public function testEditBankQuestion(): void
    {
        ...
        $url = \sprintf('/molshoop/season/krtek/question-bank/%s/edit', $bankQuestion->id);
    ...
    public function testDeleteUsedBankQuestionLeavesQuizIntact(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/season/krtek/question-bank/%s/delete', $bankQuestion->id), [
            '_token' => $token,
        ]);
    ...
    public function testAssignCopiesQuestionIntoQuiz(): void
    {
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/season/krtek/question-bank/%s/assign', $bankQuestion->id), [
            '_token' => $token,
            'quiz' => (string) $quiz->id,
        ]);
    ...
    public function testAssignSameReusableQuestionTwiceToSameQuizIsRefused(): void
    {
        ...
        $url = \sprintf('/molshoop/season/krtek/question-bank/%s/assign', $bankQuestion->id);
    ...
    {
        $this->loginAs('krtek-admin@example.org');
        $crawler = $this->client->request(Request::METHOD_GET, '/molshoop/season/krtek/question-bank');
        $token = (string) $crawler->filter('form[action$="/question-bank/labels"] input[name="_token"]')->attr('value');

        $this->client->request(Request::METHOD_POST, '/molshoop/season/krtek/question-bank/labels', [
            '_token' => $token,
            'name' => 'Opdracht',
        ]);
        $this->assertResponseRedirects('/molshoop/season/krtek/question-bank');
        ...
        $this->client->request(Request::METHOD_POST, \sprintf('/molshoop/season/krtek/question-bank/labels/%s/delete', $label->slug), [
            '_token' => $deleteToken,
        ]);
        $this->assertResponseRedirects('/molshoop/season/krtek/question-bank');
