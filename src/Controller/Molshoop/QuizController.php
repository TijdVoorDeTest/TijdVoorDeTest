...
class QuizController extends AbstractController
{
    ...
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}',
        name: 'tvdt_molshoop_quiz',
    ...
    public function index(Season $season, Quiz $quiz): Response
    {
        ...
        return $this->redirectToRoute('tvdt_molshoop_quiz_overview', ['seasonCode' => $season->seasonCode, 'quiz' => $quiz->id]);
    }

    #[IsGranted(SeasonVoter::EDIT, subject: 'season')]
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/overview',
        name: 'tvdt_molshoop_quiz_overview',
        requirements: ['seasonCode' => self::SEASON_CODE_REGEX, 'quiz' => Requirement::UUID],
    )]
    public function overview(Season $season, Quiz $quiz): Response
    {
        ...
        return $this->render('molshoop/quiz.html.twig', [
            'season' => $season,
            'quiz' => $fetchedQuiz,
            'questionErrors' => $fetchedQuiz->getQuestionErrors(),
            'activeTab' => 'overview',
            'template' => 'molshoop/quiz/tab_overview.html.twig',
        ]);
    }

    #[IsGranted(SeasonVoter::EDIT, subject: 'season')]
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/result',
        name: 'tvdt_molshoop_quiz_result',
        requirements: ['seasonCode' => self::SEASON_CODE_REGEX, 'quiz' => Requirement::UUID],
    )]
    public function result(Season $season, Quiz $quiz): Response
    {
        ...
        return $this->render('molshoop/quiz.html.twig', [
            ...
            'activeTab' => 'result',
            'template' => 'molshoop/quiz/tab_result.html.twig',
        ]);
    }

    #[IsGranted(SeasonVoter::EDIT, subject: 'season')]
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/candidates-list',
        name: 'tvdt_molshoop_quiz_candidates_tab',
        requirements: ['seasonCode' => self::SEASON_CODE_REGEX, 'quiz' => Requirement::UUID],
    )]
    public function candidatesTab(Season $season, Quiz $quiz): Response
    {
        ...
        return $this->render('molshoop/quiz.html.twig', [
            ...
            'template' => 'molshoop/quiz/tab_candidates_list.html.twig',
        ]);
    }

    #[IsGranted(SeasonVoter::EDIT, subject: 'season')]
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/answer-mapping',
        name: 'tvdt_molshoop_quiz_candidates',
        requirements: ['seasonCode' => self::SEASON_CODE_REGEX, 'quiz' => Requirement::UUID],
    )]
    public function answerMapping(Season $season, Quiz $quiz): Response
    {
        ...
        return $this->redirectToRoute('tvdt_molshoop_quiz_candidates_question', [
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'season')]
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/candidates/{question}',
        name: 'tvdt_molshoop_quiz_candidates_question',
        requirements: ['seasonCode' => self::SEASON_CODE_REGEX, 'quiz' => Requirement::UUID],
        methods: ['GET'],
    )]
    public function candidates_question(Season $season, Quiz $quiz, Question $question): Response
    {
        ...
        return $this->render('molshoop/quiz.html.twig', [
            ...
            'activeTab' => 'answers',
            'template' => 'molshoop/quiz/tab_candidates.html.twig',
        ]);
    }
    ...
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/candidates/{question}',
        name: 'tvdt_molshoop_quiz_candidates_question_save',
        requirements: ['seasonCode' => self::SEASON_CODE_REGEX, 'quiz' => Requirement::UUID],
        methods: ['POST'],
    )]
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'season')]
    #[Route(
        '/molshoop/season/{seasonCode:season}/quiz/{quiz}/enable',
        name: 'tvdt_molshoop_enable',
    ...
    public function enableQuiz(Season $season, ?Quiz $quiz, Request $request): RedirectResponse
    {
        ...
        if ('' !== $previousQuizId) {
            ...
            if ($previousQuiz instanceof Quiz && $previousQuiz->season === $season) {
                return $this->redirectToRoute('tvdt_molshoop_quiz_overview', ['seasonCode' => $season->seasonCode, 'quiz' => $previousQuiz->id]);
            }
        }
    ...
    #[Route(
        '/molshoop/quiz/{quiz}/clear',
        name: 'tvdt_molshoop_quiz_clear',
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/finalize',
        name: 'tvdt_molshoop_quiz_finalize',
        requirements: ['quiz' => Requirement::UUID],
        methods: ['POST'],
    )]
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/unfinalize',
        name: 'tvdt_molshoop_quiz_unfinalize',
        requirements: ['quiz' => Requirement::UUID],
        methods: ['POST'],
    )]
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/rename',
        name: 'tvdt_molshoop_quiz_rename',
        requirements: ['quiz' => Requirement::UUID],
        methods: ['POST'],
    )]
    ...
    #[Route(
        '/molshoop/quiz/{quiz}/delete',
        name: 'tvdt_molshoop_quiz_delete',
        requirements: ['quiz' => Requirement::UUID],
        methods: ['POST'],
    )]
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/candidate/{candidate}/modify_result',
        name: 'tvdt_molshoop_modify_result',
    ...
    public function modifyResult(Quiz $quiz, Candidate $candidate, Request $request): RedirectResponse
    {
        ...
        return $this->redirectToRoute('tvdt_molshoop_quiz_result', ['seasonCode' => $quiz->season->seasonCode, 'quiz' => $quiz->id]);
    }

    #[IsCsrfTokenValid('quiz_dropouts')]
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/modify_dropouts',
        name: 'tvdt_molshoop_modify_dropouts',
        requirements: ['quiz' => Requirement::UUID],
        methods: ['POST'],
    )]
    ...
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/candidate/{candidate}/toggle',
        name: 'tvdt_molshoop_toggle_candidate',
        requirements: ['quiz' => Requirement::UUID, 'candidate' => Requirement::UUID],
        methods: ['POST'],
    )]
    public function toggleCandidate(Quiz $quiz, Candidate $candidate): RedirectResponse
    {
        ...
        return $this->redirectToRoute('tvdt_molshoop_quiz_candidates_tab', ['seasonCode' => $quiz->season->seasonCode, 'quiz' => $quiz->id]);
    }

    #[IsCsrfTokenValid('reset_candidate_progress')]
    #[IsGranted(SeasonVoter::EDIT, subject: 'quiz')]
    #[Route(
        '/molshoop/quiz/{quiz}/candidate/{candidate}/reset',
        name: 'tvdt_molshoop_reset_candidate_progress',
        requirements: ['quiz' => Requirement::UUID, 'candidate' => Requirement::UUID],
        methods: ['POST'],
    )]
